...
async fn seed_questions(store: &IntakeGraphStore) {
    let questions = vec![
        QuestionTemplate { id: "what_brings_you_in".into(), template: "What brings you in today?".into(), ..Default::default() },
        QuestionTemplate { id: "anything_else".into(), template: "Is there anything else bothering you?".into(), ..Default::default() },
        QuestionTemplate { id: "ask_onset".into(), template: "When did {symptom} start?".into(), oldcarts_dimension: Some(OldcartsDimension::Onset), ..Default::default() },
        QuestionTemplate { id: "ask_location".into(), template: "Where exactly do you feel {symptom}?".into(), oldcarts_dimension: Some(OldcartsDimension::Location), ..Default::default() },
        QuestionTemplate { id: "ask_duration".into(), template: "How long does {symptom} typically last?".into(), oldcarts_dimension: Some(OldcartsDimension::Duration), ..Default::default() },
        QuestionTemplate { id: "ask_character".into(), template: "What does {symptom} feel like?".into(), oldcarts_dimension: Some(OldcartsDimension::Character), ..Default::default() },
        QuestionTemplate { id: "ask_aggravating".into(), template: "What makes {symptom} worse?".into(), oldcarts_dimension: Some(OldcartsDimension::Aggravating), ..Default::default() },
        QuestionTemplate { id: "ask_alleviating".into(), template: "What makes {symptom} better?".into(), oldcarts_dimension: Some(OldcartsDimension::Alleviating), ..Default::default() },
        QuestionTemplate { id: "ask_radiation".into(), template: "Does {symptom} spread to other areas?".into(), oldcarts_dimension: Some(OldcartsDimension::Radiation), ..Default::default() },
        QuestionTemplate { id: "ask_timing".into(), template: "Is there a pattern to when {symptom} happens?".into(), oldcarts_dimension: Some(OldcartsDimension::Timing), ..Default::default() },
        QuestionTemplate { id: "ask_severity".into(), template: "On a scale of 1 to 10, how would you rate {symptom}?".into(), oldcarts_dimension: Some(OldcartsDimension::Severity), ..Default::default() },
        QuestionTemplate { id: "clarify_onset".into(), template: "Just to make sure I understand — was this days, weeks, or months ago?".into(), oldcarts_dimension: Some(OldcartsDimension::Onset), ..Default::default() },
        QuestionTemplate { id: "clarify_character".into(), template: "Is it more of an ache, a sharp pain, cramping, or something else?".into(), oldcarts_dimension: Some(OldcartsDimension::Character), ..Default::default() },
        QuestionTemplate { id: "ask_prescriptions".into(), template: "Are you currently taking any prescription medications?".into(), ..Default::default() },
        QuestionTemplate { id: "ask_otc_supplements".into(), template: "Are you taking any over-the-counter medications or supplements right now?".into(), ..Default::default() },
        QuestionTemplate { id: "ask_health_conditions".into(), template: "Do you have any health conditions I should know about — things like pregnancy, kidney or liver disease, or a history of heart problems?".into(), ..Default::default() },
        QuestionTemplate { id: "ask_medications".into(), template: "Are you currently taking any prescription medications or other supplements?".into(), ..Default::default() },
        QuestionTemplate { id: "review_nervous".into(), template: "Have you noticed any tingling, numbness, or changes in sensation?".into(), ..Default::default() },
        QuestionTemplate { id: "review_digestive".into(), template: "Any changes in digestion — nausea, bloating, or bowel changes?".into(), ..Default::default() },
        QuestionTemplate { id: "review_endocrine".into(), template: "Have you noticed changes in energy, weight, or temperature sensitivity?".into(), ..Default::default() },
        QuestionTemplate { id: "review_musculoskeletal".into(), template: "Any joint stiffness, muscle weakness, or body aches?".into(), ..Default::default() },
        QuestionTemplate { id: "review_immune".into(), template: "Have you been getting sick more often or noticing increased inflammation?".into(), ..Default::default() },
        QuestionTemplate { id: "review_cardiovascular".into(), template: "Any heart palpitations, dizziness, or shortness of breath?".into(), ..Default::default() },
        QuestionTemplate { id: "review_respiratory".into(), template: "Any coughing, wheezing, or breathing difficulties?".into(), ..Default::default() },
        QuestionTemplate { id: "review_skin".into(), template: "Any skin changes — rashes, dryness, or irritation?".into(), ..Default::default() },
        QuestionTemplate { id: "ready_for_results".into(), template: "I have some thoughts on what might help. Ready to hear what the research suggests?".into(), ..Default::default() },
        QuestionTemplate { id: "causation_notice".into(), template: "I want to mention — some of your symptoms can be associated with supplements or medications. Let me factor that into what I share with you.".into(), ..Default::default() },
    ];
    for q in &questions {
